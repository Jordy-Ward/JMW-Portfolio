...
\textbf{Teaching Assistant} - Stellenbosch University \hfill 2026 - present \\
...
are captured in great detail. The goal of this project was pedagogical and software orientated.

\subsection*{Course Work}

\noindent
\textbf{Module} \dotfill \textbf{Mark}\\
Functional Programming \dotfill 79\%\\
Artificial Intelligence (Swarm) \dotfill 85\%\\
Computing and Society \dotfill 72\%\\
Space Science Algorithms \dotfill TBD\%\\
Principles of Data Science \dotfill TBD\%\\
Computer Vision \dotfill TBD\%
