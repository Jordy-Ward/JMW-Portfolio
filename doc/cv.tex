...
Highschool tutor in mathematics and IT.
...
\subsection*{Thesis}
A teaching tool for Interferometry. A space science concept and technique used to capture celestrial sources in 
the radio frequency realm. Using Earth aperature synthesis and stitching together the results from an array of radio telescopes, celestrial sources 
...
Functional Programming, Artifical Intelligence (Swarm Intelligence) and Computing and Society. \newline
